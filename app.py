            ...
            if not result['success']:
                ...
                if not rows:
                    ...
                    if account_info:
                        ...
                        with col2:
                            st.write(f"**粉丝数:** {account_info.get('follower_count', 0):,}")
                        with col3:
                    ...
                    # 计算平均值
                    avg_play = int(total_stats['play'] / len(rows)) if rows else 0
                    avg_like = int(total_stats['like'] / len(rows)) if rows else 0
